...
extern void *mono_aot_module_MobileAdsExample_info;
...
{
	mono_aot_register_module (mono_aot_module_MobileAdsExample_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MobileAdsExample.exe";
