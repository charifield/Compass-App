...
static void native_to_managed_trampoline_32 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, struct trampoline_struct_ddi p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [17].handle = objc_getClass ("UIImagePickerController");
	...
	__xamarin_class_map [66].handle = objc_getClass ("UIKit_UIView_UIViewAppearance");
